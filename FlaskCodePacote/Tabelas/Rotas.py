...
def TerceiraJanela():
    ...
    if contador is None or contador < 5:
        ...
        return render_template("TerceiraJanela.html", title = "TerceiraJanela",PresentePython= PresentePython, 
                                ...
                                TituloTop20Marca=TituloTop20Marca, ContadorGrupo2= Dado.query.with_entities(Dado.MarcaDB,Dado.AnoDB,func.count(Dado.MarcaDB).label('total2')).group_by(Dado.MarcaDB).order_by(desc('total2')).limit(20).all(),

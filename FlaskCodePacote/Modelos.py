...
class Dado(db.Model):
    ...
    ModeloDB=db.Column(db.String(40),nullable= False)
    VersaoDoMotorDB=db.Column(db.String(40),nullable= False)
    TipoDeCombustivelDB=db.Column(db.String(40),nullable= False)
